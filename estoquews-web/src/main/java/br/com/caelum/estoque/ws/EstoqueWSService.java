 ...
 * 2021-06-10T14:52:40.767-03:00
 * Generated source version: 3.3.10
 *
 */
@WebServiceClient(name = "EstoqueWSService",
                  wsdlLocation = "file:/C:/Desenvolvimento/Workspace/Projetos/estoquews-web/src/EstoqueWSServiceCap5.wsdl",
...
public class EstoqueWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Desenvolvimento/Workspace/Projetos/estoquews-web/src/EstoqueWSServiceCap5.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EstoqueWSService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Desenvolvimento/Workspace/Projetos/estoquews-web/src/EstoqueWSServiceCap5.wsdl");
        }
        WSDL_LOCATION = url;
    }
